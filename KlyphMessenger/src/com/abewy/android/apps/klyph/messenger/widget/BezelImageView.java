...
public class BezelImageView extends KlyphImageView
{
	...
	private boolean					mMaskEnabled		= false;
	...
	protected void setMaskDrawable(Drawable maskDrawable)
	{
	...
	protected void setMaskEnabled(boolean enabled)
	{
		mMaskEnabled = enabled;
	}
